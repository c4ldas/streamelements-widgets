window.addEventListener('onWidgetLoad', async function (obj){
  ...
  async function tftBadge(){
    const getRankFetch = await fetch(`https://apis.c4ldas.repl.co/api/tft/rank?type=overlay&region=${fieldData.region}&player=${fieldData.playerName}&tag=${fieldData.tag}`)
